...
public class ProdutoController {
    ...
    @PostConstruct
    public void init() {
        produtos.add(new Produto(1L, "iPhone 14", 7999.0, 50, List.of("Eletrônicos", "Smartphones")));
        produtos.add(new Produto(2L, "Samsung Galaxy S23", 6999.0, 30, List.of("Eletrônicos", "Smartphones")));
        produtos.add(new Produto(3L, "Notebook Dell Inspiron", 4999.0, 20, List.of("Eletrônicos", "Computadores")));
    }
